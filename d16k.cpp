...
int d16k(int val1, int val2, int val3) {
	...
	std::cout << R"(
         |-----------------------------------------------------------|
---------|     In Doctor Who, what was the signature look of the     |---------
---------|        fourth Doctor, as portrayed by Tom Baker?          |---------
         |-----------------------------------------------------------|
)" << '\n';
	std::cout << R"(
         |----------------------|             |----------------------|
---------|  1.Bow-tie, braces   |-------------|  2.Wide-brimmed hat  |---------
         |   and tweed jacket   |             | and extra long scarf |
         |----------------------|             |----------------------|
)" << '\n';
	std::cout << R"(
         |----------------------|             |----------------------|
---------|   3.Pinstripe suit   |-------------| 4.Cape, velvet jacket|---------
         |     and trainers     |             |   and frilly shirt   |
         |----------------------|             |----------------------|
)" << '\n';
	std::cout << R"(
                /5\                   /6\                  /7\       
...
a:
	...
	if (ans == 1 || ans == 2 || ans == 3 || ans == 4) {
		if (ans == 2) {//in this line you can change the number of the correct answer. since it works with if/else you dont need to change anything other than the number and outcome
			...
			std::cout << "\nUnfortunately the answer you gave is incorect.\n But you are still leaving the game with the safety net ammount of 1000$\n\n";
