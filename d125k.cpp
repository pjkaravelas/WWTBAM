...
int d125k(int val1, int val2, int val3) {
	...
	std::cout << R"(
         |-----------------------------------------------------------|
---------|           Construction of which of these famous           |---------
---------|              landmarks was completed first?               |---------
         |-----------------------------------------------------------|
)" << '\n';
	std::cout << R"(
         |----------------------|             |----------------------|
---------|    1.Empire State    |-------------|  2.Royal Albert Hall |---------
         |----------------------|             |----------------------|
)" << '\n';
	std::cout << R"(
         |----------------------|             |----------------------|
---------|    3.Eiffel Tower    |-------------|       4.Big Ben      |---------
         |----------------------|             |----------------------|
)" << '\n';
	std::cout << R"(
                /5\                   /6\                  /7\       
