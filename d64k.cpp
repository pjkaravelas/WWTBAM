...
int d64k(int val1, int val2, int val3) {
	...
	std::cout << R"(
         |-----------------------------------------------------------|
---------|      At the closest point, which island group is only     |---------
---------|        50 miles south-east of the coast of Florida?       |---------
         |-----------------------------------------------------------|
)" << '\n';
	std::cout << R"(
         |----------------------|             |----------------------|
---------|       1.Bahamas      |-------------| 2.US Virgin Islands  |---------
         |----------------------|             |----------------------|
)" << '\n';
	std::cout << R"(
         |----------------------|             |----------------------|
---------|   3.Caicos Islands   |-------------|       4.Bermuda      |---------
         |----------------------|             |----------------------|
)" << '\n';
	std::cout << R"(
                /5\                   /6\                  /7\       
...
a:
	...
	if (ans == 1 || ans == 2 || ans == 3 || ans == 4) {
		if (ans == 1) {//in this line you can change the number of the correct answer. since it works with if/else you dont need to change anything other than the number and outcome
