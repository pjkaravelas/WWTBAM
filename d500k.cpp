...
int d500k(int val1, int val2, int val3) {
	...
	std::cout << R"(
         |-----------------------------------------------------------|
---------|      Who is the only British politician to have held      |---------
---------|         all four “Great Offices of State” at some         |---------
         |                point during their career?                 |
         |-----------------------------------------------------------|
)" << '\n';
	std::cout << R"(
         |----------------------|             |----------------------|
---------|    1.David Lloyd     |-------------|   2.Harold Wilson    |---------
         |----------------------|             |----------------------|
)" << '\n';
	std::cout << R"(
         |----------------------|             |----------------------|
---------|  3.James Callaghan   |-------------|     4.John Major     |---------
         |----------------------|             |----------------------|
)" << '\n';
	std::cout << R"(
                /5\                   /6\                  /7\       
...
a:
	...
	if (ans == 1 || ans == 2 || ans == 3 || ans == 4) {
		if (ans == 3) {//in this line you can change the number of the correct answer. since it works with if/else you dont need to change anything other than the number and outcome
