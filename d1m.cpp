...
int d1m(int val1, int val2, int val3) {
	...
	std::cout << R"(
         |-----------------------------------------------------------|
---------|     In 1718, which pirate died in battle off the coast    |---------
---------|               of what is now North Carolina?              |---------
         |-----------------------------------------------------------|
)" << '\n';
	std::cout << R"(
         |----------------------|             |----------------------|
---------|     1.Calico Jack    |-------------|     2.Blackbeard     |---------
         |----------------------|             |----------------------|
)" << '\n';
	std::cout << R"(
         |----------------------|             |----------------------|
---------|3.Bartholomew Roberts |-------------|    4.Captain Kidd    |---------
         |----------------------|             |----------------------|
)" << '\n';
	std::cout << R"(
                /5\                   /6\                  /7\       
...
a:
	...
	if (ans == 1 || ans == 2 || ans == 3 || ans == 4) {
		if (ans == 2) {//in this line you can change the number of the correct answer. since it works with if/else you dont need to change anything other than the number and outcome
			std::cout << "The answer you gave is correct!! Congratulations!! You just won 1 MILLION DOLLARS!!";
			...
			std::cout << "\nUnfortunately the answer you gave is incorect.\nYou came so close...\nBut you are still leaving the game with the safety net ammount of 32000$\n\n";
