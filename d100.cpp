...
int d100(/*val1, val2, val3*/) {
	...
	std::cout << R"(
         |-----------------------------------------------------------|
---------|         In the UK, the abbreviation NHS stands for        |---------
	...
	if (ans == 1 || ans == 2 || ans == 3 || ans == 4) {
		...
		if (ans == 5) {
			if (life_50 == 1) {
				...
				do {
					v1 = rand() % 5;
				} while (v1 == 2 /*correct answer*/ || v1 == 0);

				do {
					v2 = rand() % 5;
				} while (v2 == 2 /*correct answer*/ || v2 == 0);
